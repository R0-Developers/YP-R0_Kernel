...
/* PCM Recording When Playback */
struct record_playback mxc_record_playback;
EXPORT_SYMBOL(mxc_record_playback);
...
static int dma_new_period(struct snd_pcm_substream *substream)
{
	...
	if ((substream->stream == SNDRV_PCM_STREAM_PLAYBACK) && 
		...
		mxc_record_playback.complete(&mxc_record_playback);
	}
...
static int imx_pcm_open(struct snd_pcm_substream *substream)
{
	...
	/* PCM Recording When Playback */					   
	mxc_record_playback.runtime = runtime;
