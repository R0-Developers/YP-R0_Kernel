...
#define		MAX_RO_PARTS		(7)				/* never modify this parameter */
...
typedef struct {
	UINT32	nRoAreaStart;
	UINT32	nRoAreaSizeVB;
	UINT32	nRoAreaSizePB;
	UINT32	nRoPartNum;

	ROPartTbl	aPatTbl[MAX_RO_PARTS+1]; /* + 1 for RW_PART (DATA_SECTION) */
} ROAreaMeta;
#endif
