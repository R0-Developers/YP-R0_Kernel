...
void gpio_i2c_inactive(int i2c_num)
{
	...
	{
	case 0:
		mxc_free_iomux(MX37_PIN_I2C1_CLK, IOMUX_CONFIG_ALT4);
		mxc_free_iomux(MX37_PIN_I2C1_DAT, IOMUX_CONFIG_ALT4);
		mxc_free_iomux(MX37_PIN_I2C1_CLK, IOMUX_CONFIG_ALT0);
		mxc_free_iomux(MX37_PIN_I2C1_DAT, IOMUX_CONFIG_ALT0);
		break;
	case 1:
		mxc_free_iomux(MX37_PIN_GPIO1_0, IOMUX_CONFIG_ALT0);
		mxc_free_iomux(MX37_PIN_GPIO1_1, IOMUX_CONFIG_ALT0);
		mxc_free_iomux(MX37_PIN_GPIO1_0, (IOMUX_CONFIG_SION | IOMUX_CONFIG_ALT2));
		mxc_free_iomux(MX37_PIN_GPIO1_1, (IOMUX_CONFIG_SION | IOMUX_CONFIG_ALT2));
		break;
	case 2:
		break;
	default:
...
EXPORT_SYMBOL(gpio_i2s_enable);

void gpio_i2s_disable(void)
{
	/* GPIO2_22 */
	mxc_request_iomux(MX37_PIN_AUD5_WB_CK, IOMUX_CONFIG_ALT4);
	mxc_set_gpio_direction(MX37_PIN_AUD5_WB_CK, 1);
//	mxc_set_gpio_dataout(MX37_PIN_AUD5_WB_CK, 0);
	/* GPIO2_21 */
	mxc_request_iomux(MX37_PIN_AUD5_WB_RXD, IOMUX_CONFIG_ALT4);
	mxc_set_gpio_direction(MX37_PIN_AUD5_WB_RXD, 1);
//	mxc_set_gpio_dataout(MX37_PIN_AUD5_WB_RXD, 0);
	/* GPIO2_20 */
	mxc_request_iomux(MX37_PIN_AUD5_WB_TXD, IOMUX_CONFIG_ALT4);
	mxc_set_gpio_direction(MX37_PIN_AUD5_WB_TXD, 1);
//	mxc_set_gpio_dataout(MX37_PIN_AUD5_WB_TXD, 0);
	/* GPIO2_23 */
	mxc_request_iomux(MX37_PIN_AUD5_WB_FS, IOMUX_CONFIG_ALT4);
	mxc_set_gpio_direction(MX37_PIN_AUD5_WB_FS, 1);
//	mxc_set_gpio_dataout(MX37_PIN_AUD5_WB_FS, 0);

}
EXPORT_SYMBOL(gpio_i2s_disable);
...
EXPORT_SYMBOL(mxc_init_pmu_port);
...
EXPORT_SYMBOL(mxc_external_mute);
...
void afe_backlight_on(void)
{
	as3543_write_subreg(AFE_MUX_PMU_REG5, 0x01, 0xb1);
}

void afe_backlight_off(void)
{
	as3543_write_subreg(AFE_MUX_PMU_REG5, 0x01, 0x00);
}
EXPORT_SYMBOL(afe_backlight_on);
EXPORT_SYMBOL(afe_backlight_off);

void afe_system_off(void)
{
	as3543_write_reg(AFE_SYSTEM, 0x03);
}
EXPORT_SYMBOL(afe_system_off);
...
int gpio_pba_is_active(void)
{
	KernelParam *kParam;
	kParam = KernelParamGet();

	return kParam->ucPBAMode;
}
EXPORT_SYMBOL(gpio_pba_is_active);
